...
public class TeleOpTest extends LinearOpMode {
    ...
    public <px, py, rx, ry, head> Vector2d DriveVector(double Px, double Py, double Rx, double Ry, double Head) {
        ...
        return new Vector2d(
                ((gamepad1.left_stick_y * java.lang.Math.sin(lookAng - head))
                        - (gamepad1.left_stick_x * java.lang.Math.cos(lookAng - head))) / 1.5,
                ((gamepad1.left_stick_y * java.lang.Math.cos(lookAng - head))
                        + (gamepad1.left_stick_x * java.lang.Math.sin(lookAng - head))) / 1.5
        );
    }
}
